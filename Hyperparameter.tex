\makesectionpage{Hyperparameter}
...
\end{blockC1}
\end{columns}
\source{Gridsearch Random Forest.ipynb}
\end{frame}
...
\end{blockC1}
\end{columns}
\source{Gridsearch Neuronales Netz.ipynb}
\end{frame}
...
\begin{columns}
\column{0.60\textwidth}
Verwenden Sie die Vorlage \textbf{Projekt Ziffernerkennung.ipynb}. Sie
...
\end{columns}
\source{Vorlage: Projekt Ziffernerkennung.ipynb}
\end{frame}
