\makesectionpage[figures/Schwarmintelligenz2.png]{Schwarmintelligenz}
...
\end{column}
\end{columns}
\source{\cite{kennedy1995particle}, PSOFunctionplot.py}
\end{frame}
...
\begin{blockrow}
\begin{blockcol}{0.48\textwidth}{block}{Bedeutung}
\begin{itemize}
...
\begin{blockcol}{0.48\textwidth}{blockC2}{Wirkung}
\begin{itemize}
...
\begin{blockcol}{0.48\textwidth}{blockC1}{Stärken}
\begin{itemize}
...
\begin{blockcol}{0.48\textwidth}{blockC2}{Grenzen}
\begin{itemize}
...
\begin{frame}{Gruppenarbeit: Verfahren selbst entdecken}
\vspace{0.5em}
\begin{columns}
\begin{column}{0.35\textwidth}
\centering
\twemoji[width=0.4\linewidth]{rocket}\\[1em]
\footnotesize
\textbf{3 Gruppen}\\
je ein Verfahren\\[0.5em]
\textbf{45 Minuten}\\
Bearbeitungszeit\\[0.5em]
\textbf{Ergebnis}\\
Folien und lauffähiges Programm
\end{column}
\begin{column}{0.6\textwidth}
\footnotesize
\begin{block}{\footnotesize Ihr Auftrag}
\begin{itemize}
  \item Bilden Sie drei Gruppen zu je einem Verfahren: \textbf{ABC}, \textbf{Ant Colony}, \textbf{Evolutionäre Algorithmen}.
  \item Lesen Sie den zugehörigen Artikel im \textbf{Moodle-Kurs}.
  \item Teilen Sie sich in zwei Teilgruppen auf:
  \begin{itemize}
    \footnotesize
    \item \textbf{Team Theorie:} beschreibt den Algorithmus auf ein bis zwei Folien.
    \item \textbf{Team Praxis:} findet das Minimum der \emph{Ackley-Funktion}, das Programm entsteht per \emph{Vibe Coding}.
  \end{itemize}
  \item Präsentieren Sie Folien und Programm anschließend der gesamten Gruppe.
\end{itemize}
\end{block}
\end{column}
\end{columns}
