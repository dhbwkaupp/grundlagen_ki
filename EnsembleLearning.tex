...
\end{columns}
\source{Lösung: Ensemble Iris.ipynb}
\end{frame}
...
\begin{columns}
\column{0.65\textwidth}
Öffnen Sie das Notebook \texttt{HeartDisease\_Entscheidungsbaum.ipynb}.
...
\twemoji[width=0.8\linewidth]{laptop}
\end{columns}
\source{Lösung: HeartDisease Ensemble.ipynb}
\end{frame}
