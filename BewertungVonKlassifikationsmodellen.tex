...
% viele "zulässig" (blau), ein "Betrug" (rot)
...
\vspace{0.6em}
\begin{blockrow}
\begin{blockcol}{0.48\textwidth}{blockC1}{Korrekt klassifiziert}
\begin{itemize}
...
\begin{blockcol}{0.47\textwidth}{blockC2}{Falsch klassifiziert}
\begin{itemize}
...
\begin{blockrow}
\begin{blockcol}{0.49\textwidth}{blockC1}{Trefferquote (Accuracy)}
...
\begin{blockcol}{0.48\textwidth}{blockC2}{Fehlerrate}
...
\end{itemize}
\end{columns}
\source{EntscheidungsbaumConfusionMatrix.ipynb}
\end{frame}
...
\end{columns}
\source{Lösung: LösungEntscheidungsbaumKonfusionsmatrix.ipynb}
\end{frame}
