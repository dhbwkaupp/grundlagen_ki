...
\source{\cite{seemann2024mlaz}, Diamanten Ordinale Daten.ipynb  }
\end{frame}
...
\source{\cite{seemann2024mlaz}, One Hot Fahrzeugdaten.ipynb}
\end{frame}
...
# Kategoriale Spalte mit haeufigstem Wert
...
\end{columns}
\source{Lösung: Diamanten ordinale Daten komplett.ipynb}
\end{frame}
