...
\begin{itemize}
\item notwendige Bedingung für Minimum
\item lineares Gleichungssystem entsteht
\end{itemize}

\column{0.48\textwidth}


hier 3D-Funktion aus Gradientenabstieg Backpropagation.ipynb
 einfügen!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

\begin{block}{Interpretation}
\begin{itemize}
\item Fehlervektor ist orthogonal zum Spaltenraum von $A$
\end{itemize}
\end{block}
...
\textbf{Eigenschaften:}
\begin{itemize}
\item quadratisches System
\item lösen mit linearen Methoden
\end{itemize}
...
\begin{frame}{Lösung der Normalgleichung}
...
\item ergibt optimale Parameter
\end{itemize}

\column{0.48\textwidth}

\begin{block}{Einschränkung}
\begin{itemize}
\item Inversion kann instabil sein
\item numerisch oft ungeeignet
\end{itemize}
...
\textbf{Praxis:}
\begin{itemize}
\item Nutzung stabiler Verfahren
\end{itemize}
\end{block}
