...
\medskip
  ...
  \begin{column}{0.25\textwidth}
    ...
    \begin{tikzpicture}[scale=1.0]
      % Behälter (oben offen)
      \draw[thick] (0,0) -- (3,0);      % Boden
      \draw[thick] (0,0) -- (0,2);      % linke Wand
      \draw[thick] (3,0) -- (3,2);      % rechte Wand

      % Kugeln auf dem Boden (alle gleich)
      \draw[thick, draw=black, fill=PrimaryColor]  (0.3,0.35) circle (0.22);
      \draw[thick, draw=black, fill=PrimaryColor]  (0.9,0.35) circle (0.22);
      \draw[thick, draw=black, fill=PrimaryColor]  (1.5,0.35) circle (0.22);
      \draw[thick, draw=black, fill=PrimaryColor]  (2.1,0.35) circle (0.22);
      \draw[thick, draw=black, fill=PrimaryColor]  (2.7,0.35) circle (0.22);
    \end{tikzpicture}
  \end{column}
\end{columns}
\source{\cite{strutz2025bilddatenkompression}}
...
\begin{columns}
  ...
  \begin{column}{0.25\textwidth}
    ...
    \begin{tikzpicture}[scale=1.0]
      ...
      % Kugeln auf dem Boden, bunt gemischt
      \draw[thick, draw=black, fill=PrimaryColor]   (0.3,0.35) circle (0.22);
      \draw[thick, draw=black, fill=AlertColor]    (0.9,0.35) circle (0.22);
      \draw[thick, draw=black, fill=ThirdColor]   (1.5,0.35) circle (0.22);
      \draw[thick, draw=black, fill=ExampleColor]     (2.1,0.35) circle (0.22);
      \draw[thick, draw=black, fill=AccentColor]    (2.7,0.35) circle (0.22);
    \end{tikzpicture}
  \end{column}
\end{columns}
\source{\cite{strutz2025bilddatenkompression}}
